    ...
    <div className="border-b border-neutral-800 pb-24">
      ...
      >
        ...
        <motion.div
          ...
          className="rounded-2xl border-4 border-neutral-800 p-4"
        >
          <SiMui className="text-7xl text-[#DD4B25]" />
        </motion.div>
        <motion.div
        ...
        <motion.div
          ...
          className="rounded-2xl border-4 border-neutral-800 p-4"
        >
          <SiTypescript className="text-7xl text-[#EFD81D]" />
        </motion.div>
        <motion.div
        ...
        <motion.div
          ...
          className="rounded-2xl border-4 border-neutral-800 p-4"
        >
          <RiNextjsFill className="text-7xl text-[#DD4B25]" />
        </motion.div>
        <motion.div
          variants={iconVariants(2)}
          initial="initial"
          ...
          className="rounded-2xl border-4 border-neutral-800 p-4"
        >
          <RiNodejsLine  className="text-7xl text-[#254BDD]"/>
        </motion.div>
        <motion.div
          variants={iconVariants(2)}
          initial="initial"
          ...
          className="rounded-2xl border-4 border-neutral-800 p-4"
        >
          <SiExpress className="text-7xl text-g-500" />
        </motion.div>
        <motion.div
          variants={iconVariants(2)}
          initial="initial"
        ...
        <motion.div
          ...
          className="rounded-2xl border-4 border-neutral-800 p-4"
        >
          <SiMysql className="text-7xl text-[#EFD81D]" />
        </motion.div>
        <motion.div
          variants={iconVariants(2)}
          initial="initial"
        ...
        <motion.div
          ...
          className="rounded-2xl border-4 border-neutral-800 p-4"
        >
          <SiJest className="text-7xl text-black-800" />
        </motion.div>
      </motion.div>
    </div>
  );
